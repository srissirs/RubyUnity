...
public class RubyController : MonoBehaviour
{
    ...
    int fixedEnemiespriv;

    public int  fixedEnemies { get; set;}
    ...
    void Update()
    {
        ...
        // Leaving building
            ...
            RaycastHit2D hit1 = Physics2D.Raycast(rigidbody2d.position + Vector2.up * 0.2f, lookDirection, 1.5f, LayerMask.GetMask("WayOut"));
